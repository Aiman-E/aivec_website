...
interface ObjectFileWithAclMetadata {
  name?: string;
...
export async function setObjectAclPolicy(
  objectFile: ObjectFileWithAclMetadata,
  aclPolicy: ObjectAclPolicy,
): Promise<void> {
  if (objectFile.setAclPolicy) {
  ...
  objectFile.metadata = {
    ...(objectFile.metadata ?? {}),
    [ACL_POLICY_METADATA_KEY]: aclPolicy,
  };
}
