          ...
          <Link href={`/${lang}`} className="flex items-center gap-3 lg:gap-4 z-50 group min-w-0 flex-1 lg:flex-initial">
            {logoSrc ? (
              <img
                src={logoSrc}
                alt={siteTitle}
                className="w-[63px] h-[63px] lg:w-[75px] lg:h-[75px] shrink-0 object-contain -my-3 lg:-my-4"
              />
            ) : (
              <div className="w-[63px] h-[63px] lg:w-[75px] lg:h-[75px] shrink-0 bg-primary flex items-center justify-center rounded-sm overflow-hidden relative shadow-lg -my-3 lg:-my-4">
